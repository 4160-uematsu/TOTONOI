...
<div class="mx-auto mt-10 p-8 w-2/4 bg-white border-4 border-double border-indigo-500">
    ...
    <ul class="text-center mx-auto">
        ...
        <li class="text-xl font-semibold mt-3 text-gray-600">
            ...
            <textarea name="promotion" type="text" cols="30" rows="10"></textarea>
        </li>
        <li class="text-xl font-semibold mt-3 text-gray-600">
        ...
        <li class="text-xl font-semibold mt-3 text-gray-600">
            ...
            <div class="box13">
                <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg originalbtn mt-5">登録</button>
            </div>
        </div>
        </ul>
    </form>
